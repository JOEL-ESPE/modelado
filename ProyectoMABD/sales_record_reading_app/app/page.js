...
export default function Home() {
  ...
  async function loadSales() {
    const result = await axios("http://192.168.100.48:3003/sales");
  ...
  async function handleCreate() {
    const response = await axios.post(
      "http://192.168.100.48:3003/sales/create",
      newUserForm,
      {
        headers: {
  ...
  async function handleEdit() {
    const response = await axios.post(
      "http://192.168.100.48:3003/sales/edit",
      selected,
      {
        headers: {
          "Content-Type": "application/json",
  ...
  async function handleDelete(id) {
    const response = await axios.post(
      "http://192.168.100.48:3003/sales/delete",
      { _id: id },
      {
        headers: {
          "Content-Type": "application/json",
